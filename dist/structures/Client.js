...
class NamooClient extends discord_js_1.Client {
    ...
    async loadCommands() {
        const commandsPath = node_fs_1.default.readdirSync(node_path_1.default.join(__dirname, '../commands'));
    ...
    async loadEvents() {
        const eventsPath = node_fs_1.default.readdirSync(node_path_1.default.join(__dirname, '..', 'events'));
        for (const dir of eventsPath) {
            const eventFiles = node_fs_1.default.readdirSync(node_path_1.default.join(__dirname, '..', 'events', dir)).filter(file => file.endsWith('.js'));
