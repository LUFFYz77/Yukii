...
class Lyrics extends index_1.Command {
    ...
    async run(client, ctx) {
        ...
        try {
            const lyrics = await (0, genius_lyrics_api_1.getLyrics)(options);
            if (lyrics) {
                ...
                await ctx.editMessage({
                    embeds: [
                        embed
                            ...
                            .setDescription(ctx.locale('cmd.lyrics.lyrics_track', { trackTitle, trackUrl, lyrics: lyricsPages[currentPage] }))
