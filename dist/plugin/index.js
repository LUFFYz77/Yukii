...
const pluginsFolder = node_path_1.default.join(__dirname, 'plugins');
async function loadPlugins(client) {
    try {
        const pluginFiles = node_fs_1.default.readdirSync(pluginsFolder).filter(file => file.endsWith('.js'));
