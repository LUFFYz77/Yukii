...
var Rate = /** @class */ (function (_super) {
    ...
    Rate.prototype.run = function (client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            var player, rateString, isValidNumber, rate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        rateString = args[0].replace(',', '.');
                        isValidNumber = /^[0-9]*\.?[0-9]+$/.test(rateString);
                        rate = Number.parseFloat(rateString);
                        if (!(!isValidNumber || Number.isNaN(rate) || rate < 0.5 || rate > 5)) return [3 /*break*/, 4];
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                    case 4: return [4 /*yield*/, player.filterManager.setRate(rate)];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
