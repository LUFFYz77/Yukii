...
var Pitch = /** @class */ (function (_super) {
    ...
    Pitch.prototype.run = function (client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            var player, pitchString, isValidNumber, pitch;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        pitchString = args[0].replace(',', '.');
                        isValidNumber = /^[0-9]*\.?[0-9]+$/.test(pitchString);
                        pitch = Number.parseFloat(pitchString);
                        if (!(!isValidNumber || Number.isNaN(pitch) || pitch < 0.5 || pitch > 5)) return [3 /*break*/, 4];
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                    case 4: return [4 /*yield*/, player.filterManager.setPitch(pitch)];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
