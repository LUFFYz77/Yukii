...
var Tremolo = /** @class */ (function (_super) {
    ...
    Tremolo.prototype.run = function (client, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var player, tremoloEnabled;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        tremoloEnabled = player.filterManager.filters.tremolo;
                        if (!tremoloEnabled) return [3 /*break*/, 4];
