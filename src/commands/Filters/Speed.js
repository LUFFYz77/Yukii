...
var Speed = /** @class */ (function (_super) {
    ...
    Speed.prototype.run = function (client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            var player, speedString, isValidNumber, speed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        speedString = args[0].replace(',', '.');
                        isValidNumber = /^[0-9]*\.?[0-9]+$/.test(speedString);
                        speed = Number.parseFloat(speedString);
                        if (!(!isValidNumber || Number.isNaN(speed) || speed < 0.5 || speed > 5)) return [3 /*break*/, 4];
