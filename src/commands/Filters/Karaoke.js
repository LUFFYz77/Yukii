...
var Karaoke = /** @class */ (function (_super) {
    __extends(Karaoke, _super);
    function Karaoke(client) {
    ...
    Karaoke.prototype.run = function (client, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        filterEnabled = player.filterManager.filters.karaoke;
                        if (!filterEnabled) return [3 /*break*/, 5];
                        return [4 /*yield*/, player.filterManager.toggleKaraoke()];
                    case 3:
                        _a.sent();
                    ...
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 5: return [4 /*yield*/, player.filterManager.toggleKaraoke()];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
