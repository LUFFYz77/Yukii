...
var Vibrato = /** @class */ (function (_super) {
    ...
    Vibrato.prototype.run = function (client, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var player, vibratoEnabled;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        vibratoEnabled = player.filterManager.filters.vibrato;
                        if (!vibratoEnabled) return [3 /*break*/, 4];
