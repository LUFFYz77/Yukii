...
var RemoveOwner = /** @class */ (function (_super) {
    __extends(RemoveOwner, _super);
    ...
    RemoveOwner.prototype.run = function (_client, ctx, args) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(!ownerId || !/^\d+$/.test(ownerId))) return [3 /*break*/, 2];
                    ...
                    case 2:
                        _a.trys.push([2, 5, , 7]);
                        return [4 /*yield*/, this.client.db.removeOwner(ownerId)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
                                    this.client.embed()
                                        ...
                                        .setDescription("Successfully removed <@".concat(ownerId, "> as an owner of bot")),
                                ],
                            })];
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
                                    this.client.embed()
                                        .setColor(this.client.color.red)
                                        .setDescription(error_1.message || 'An error occurred while removing the owner'),
                                ],
                            })];
