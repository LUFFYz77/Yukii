...
var AddOwner = /** @class */ (function (_super) {
    __extends(AddOwner, _super);
    ...
    AddOwner.prototype.run = function (_client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 5, , 7]);
                        return [4 /*yield*/, this.client.db.addOwner(ownerId)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
                                    this.client.embed()
                                        ...
                                        .setDescription("Successfully added <@".concat(ownerId, "> as an owner of bot")),
                                ],
                            })];
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
                                    this.client.embed()
                                        .setColor(this.client.color.red)
                                        .setDescription(error_1.message || 'An error occurred while adding the owner'),
                                ],
                            })];
