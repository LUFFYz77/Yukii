...
var CreatePlaylist = /** @class */ (function (_super) {
    ...
    CreatePlaylist.prototype.run = function (client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            var name, embed, playlistExists;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!(name.length > 50)) return [3 /*break*/, 2];
                    ...
                    case 2: return [4 /*yield*/, client.db.getPlaylist((_a = ctx.author) === null || _a === void 0 ? void 0 : _a.id, name)];
                    case 3:
                        playlistExists = _c.sent();
                        if (!playlistExists) return [3 /*break*/, 5];
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
                    ...
                    case 5: return [4 /*yield*/, client.db.createPlaylist((_b = ctx.author) === null || _b === void 0 ? void 0 : _b.id, name)];
                    case 6:
                        _c.sent();
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
