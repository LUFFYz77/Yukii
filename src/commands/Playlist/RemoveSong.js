...
var RemoveSong = /** @class */ (function (_super) {
    __extends(RemoveSong, _super);
    function RemoveSong(client) {
    ...
    RemoveSong.prototype.run = function (client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            var playlist, song, errorMessage, errorMessage, playlistData, playlistNotFoundError;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        errorMessage = this.client
                            .embed()
                            .setDescription(ctx.locale('cmd.removesong.messages.provide_playlist'))
                            .setColor(this.client.color.red);
                        return [4 /*yield*/, ctx.sendMessage({ embeds: [errorMessage] })];
                    ...
                    case 4: return [4 /*yield*/, client.db.getPlaylist((_a = ctx.author) === null || _a === void 0 ? void 0 : _a.id, playlist)];
                    case 5:
                        playlistData = _b.sent();
                        if (!!playlistData) return [3 /*break*/, 7];
                        playlistNotFoundError = this.client
                            .embed()
                            .setDescription(ctx.locale('cmd.removesong.messages.playlist_not_exist'))
                            .setColor(this.client.color.red);
                        return [4 /*yield*/, ctx.sendMessage({ embeds: [playlistNotFoundError] })];
    ...
    RemoveSong.prototype.autocomplete = function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
