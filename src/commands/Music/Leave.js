...
var Leave = /** @class */ (function (_super) {
    ...
    Leave.prototype.run = function (client, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var player, embed, channelId;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [embed.setColor(this.client.color.main).setDescription(ctx.locale('cmd.leave.left', { channelId: channelId }))],
                            })];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2: return [4 /*yield*/, ctx.sendMessage({
