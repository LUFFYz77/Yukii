...
var Play = /** @class */ (function (_super) {
    ...
    Play.prototype.run = function (client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            var query, player, memberVoiceChannel, response, embed, track, embed_1, message_1, embed_2, message_2;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        query = args.join(' ');
                        return [4 /*yield*/, ctx.sendDeferMessage(ctx.locale('cmd.play.loading', { emoji: client.emoji.music.searching }))];
                    case 1:
                        _b.sent();
                        ...
                        if (!!player.connected) return [3 /*break*/, 3];
                        return [4 /*yield*/, player.connect()];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, player.search({ query: query }, ctx.author)];
                    case 4:
                        response = (_b.sent());
                    ...
                    case 6: return [4 /*yield*/, player.queue.add(response.loadType === 'playlist' ? response.tracks : response.tracks[0])];
                    case 7:
                        _b.sent();
                    ...
                    case 9:
                        ...
                        if (!track) return [3 /*break*/, 11];
                        embed_1 = client.embed()
                            .setColor(client.color.main)
                            .setDescription(ctx.locale('cmd.play.added_to_queue', {
                            title: response.tracks[0].info.title,
                            uri: response.tracks[0].info.uri,
                        }));
                        return [4 /*yield*/, ctx.editMessage({ content: '', embeds: [embed_1] })];
                    case 10:
                        message_1 = _b.sent();
                        setTimeout(function () { return message_1.delete().catch(console.error); }, 5000);
                        return [3 /*break*/, 13];
                    case 11:
                        embed_2 = client.embed()
                            .setColor(client.color.main)
                            .setDescription(ctx.locale('cmd.play.started_playing', {
                            title: response.tracks[0].info.title,
                            uri: response.tracks[0].info.uri,
                        }));
                        return [4 /*yield*/, ctx.editMessage({ content: '', embeds: [embed_2] })];
                    case 12:
                        message_2 = _b.sent();
                        setTimeout(function () { return message_2.delete().catch(console.error); }, 5000);
                        _b.label = 13;
                    case 13:
                        if (!(!player.playing && player.queue.tracks.length > 0)) return [3 /*break*/, 15];
    ...
    Play.prototype.autocomplete = function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
