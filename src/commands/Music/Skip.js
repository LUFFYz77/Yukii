...
var Skip = /** @class */ (function (_super) {
    ...
    Skip.prototype.run = function (client, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var player, embed, currentTrack;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        if (!(player.queue.tracks.length === 0)) return [3 /*break*/, 4];
                    ...
                    case 4:
                        currentTrack = (_a = player.queue.current) === null || _a === void 0 ? void 0 : _a.info;
                        player.skip();
                        if (!ctx.isInteraction) return [3 /*break*/, 6];
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
                                    embed.setColor(this.client.color.main).setDescription(ctx.locale('cmd.skip.messages.skipped', {
                                        title: currentTrack === null || currentTrack === void 0 ? void 0 : currentTrack.title,
                                        uri: currentTrack === null || currentTrack === void 0 ? void 0 : currentTrack.uri,
                                    })),
                                ],
                            })];
                    case 5: return [2 /*return*/, _c.sent()];
                    case 6:
                        (_b = ctx.message) === null || _b === void 0 ? void 0 : _b.react('👍');
                        return [2 /*return*/];
                }
            });
        });
