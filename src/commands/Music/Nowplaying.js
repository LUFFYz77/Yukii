...
var Nowplaying = /** @class */ (function (_super) {
    ...
    Nowplaying.prototype.run = function (client, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var player, track, position, duration, bar, embed;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        bar = client.utils.progressBar(position, duration, 20);
                        embed = this.client.embed()
                            .setColor(this.client.color.main)
                            .setAuthor({
                            name: ctx.locale('cmd.nowplaying.now_playing'),
                            iconURL: (_a = ctx.guild) === null || _a === void 0 ? void 0 : _a.iconURL({}),
                        })
                            .setThumbnail(track.info.artworkUrl)
                            .setDescription(ctx.locale('cmd.nowplaying.track_info', {
                            ...
                            .addFields({
                            name: '\u200b',
                            value: "`".concat(client.utils.formatTime(position), " / ").concat(client.utils.formatTime(duration), "`"),
                        });
