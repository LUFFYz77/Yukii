...
var Seek = /** @class */ (function (_super) {
    __extends(Seek, _super);
    function Seek(client) {
    ...
    Seek.prototype.run = function (client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            var player, current, embed, duration;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        player = client.manager.getPlayer(ctx.guild.id);
                        current = (_a = player === null || player === void 0 ? void 0 : player.queue.current) === null || _a === void 0 ? void 0 : _a.info;
                        embed = this.client.embed();
                        duration = client.utils.parseTime(args.join(' '));
                    ...
                    case 2:
                        if (!(!(current === null || current === void 0 ? void 0 : current.isSeekable) || current.isStream)) return [3 /*break*/, 4];
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [embed.setColor(this.client.color.red).setDescription(ctx.locale('cmd.seek.errors.not_seekable'))],
                            })];
                    case 3: return [2 /*return*/, _b.sent()];
                    case 4:
                        if (!(duration > current.duration)) return [3 /*break*/, 6];
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
                    ...
                    case 6:
                        player === null || player === void 0 ? void 0 : player.seek(duration);
                        return [4 /*yield*/, ctx.sendMessage({
                                embeds: [
