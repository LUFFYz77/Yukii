...
var Skipto = /** @class */ (function (_super) {
    __extends(Skipto, _super);
    function Skipto(client) {
    ...
    Skipto.prototype.run = function (client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            var player, embed, num;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        if (!(player.queue.tracks.length === 0 || Number.isNaN(num) || num > player.queue.tracks.length || num < 1)) return [3 /*break*/, 4];
