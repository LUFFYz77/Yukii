...
var Remove = /** @class */ (function (_super) {
    ...
    Remove.prototype.run = function (client, ctx, args) {
        return __awaiter(this, void 0, void 0, function () {
            var player, embed, songNumber;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        songNumber = Number(args[0]);
                        if (!(Number.isNaN(songNumber) || songNumber <= 0 || songNumber > player.queue.tracks.length)) return [3 /*break*/, 6];
                        return [4 /*yield*/, ctx.sendMessage({
