    ...
    Ready.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        this.client.logger.success("".concat((_a = this.client.user) === null || _a === void 0 ? void 0 : _a.tag, " is ready!"));
                        ...
                        if (env_1.env.TOPGG) {
                            autoPoster_1 = (0, topgg_autoposter_1.AutoPoster)(env_1.env.TOPGG, this.client);
                            setInterval(function () {
                                autoPoster_1.on('posted', function (_stats) {
                                    null;
                                });
                        ...
                        return [4 /*yield*/, this.client.manager.init(__assign(__assign({}, this.client.user), { shards: 'auto' }))];
                    case 1:
                        _c.sent();
                        return [2 /*return*/];
                }
